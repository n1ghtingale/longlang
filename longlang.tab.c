...
{
      25,     0,    -1,     5,    -1,    25,    20,    25,    -1,    25,
      19,    25,    -1,    25,    21,    25,    -1,    25,    22,    25,
      -1,    25,    23,    25,    -1
};
...
{
  "$end", "error", "$undefined", "LINE", "STMT", "CONST", "EXE", "IFSTMT",
  "FORSTMT", "newL", "show", "showH", "var", "to", "eql", "FOR", "IF",
  "NUM", "wrong", "'-'", "'+'", "'*'", "'/'", "'%'", "$accept", "EXP", 0
};
#endif
...
#line 26 "longlang.y"
    {
			...
			Syntax *tmp_syntax = (Syntax*) immediate_new((yyvsp[(1) - (1)]));
